...
function chkPass(pwd) {
	var oScorebar = innerFunction1("scorebar");
	var oScore = innerFunction1("score");
	var oComplexity = innerFunction1("complexity");
...
function togPwdMask() {
	var oPwd = innerFunction1("passwordPwd");
	var oTxt = innerFunction1("passwordTxt");
	var oMask = innerFunction1("mask");
	if (oMask.checked) { 
...
function initPwdChk(restart) {
	...
	$("passwordPwd").value = "";
	$("passwordTxt").value = "";
	innerFunction1("scorebar").style.backgroundPosition = "0";
	if (restart) {
